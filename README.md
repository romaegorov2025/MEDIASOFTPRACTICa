...
{ "name": "Product A", "price": 10.0, "quantity": 100 }
DELETE /products/{id}: Удалить продукт

Параметры: id (идентификатор продукта)
PUT /products/{id}: Обновить данные продукта

Тело запроса:
json

{ "name": "Updated Product A", "price": 15.0, "quantity": 50 }
GET /products: Получить список всех продуктов

POST /orders: Оформить покупку товара
